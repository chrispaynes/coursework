    ...
    <ul class='index_component' class='col-xs-12'>
      ...
      <li v-for='(p, index) in posts'
        ...
        <div class='row'>
          ...
          <div class='col-xs-offset-1 col-xs-3 col-md-offset-0 col-md-2'>by {{ p.author_username }}</div>
          <div class='col-xs-8 col-md-4'>on {{ p.post_last_updated }}</div>
        </div>
